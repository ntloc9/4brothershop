<?php 
 ...
 ?>
<form action="modules/quanlythongtin/xuly.php?id=<?php echo $dong['id']; ?>" method="post" enctype="multipart/form-data">
	<table width="100%" border="1">
		<tr>
			<td colspan="2"> <div align="center">Edit new type of product</div></td>
		</tr>
		<tr>
			<td>ID</td>
