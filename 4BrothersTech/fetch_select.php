...
if(isset($_POST['category']))
{
	...
	foreach ($attributes as $attribute) {
		...
		echo "<input type='text' class='form-control' name='attributes_values[]' required autocomplete='off'>";
		echo "</div>";
	}
...
if(isset($_POST['id']))
{
	...
	foreach ($attributes as $attribute) {
		...
		echo "<div class='form-group'>";
		echo "<label for='".$attribute['attribute']."'>".$attribute['attribute'].":</label>";
		echo "<input type='text' class='form-control' name='attributes_values[]' value ='".htmlspecialchars($attribute_value)."' required autocomplete='off'>";
